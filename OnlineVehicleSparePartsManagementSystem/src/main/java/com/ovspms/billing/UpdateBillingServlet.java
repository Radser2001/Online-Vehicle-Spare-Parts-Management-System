...
/**
 * Servlet implementation class UpdateBillingServlet
 */
@WebServlet("/update-billing-details")
public class UpdateBillingServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		isTrue = BillingDBUtil.updateBiiling(id, fname, lname, email, phone, country, state, address1, address2, postal,
				company);
		if (isTrue == true) {
